...
export function TokenUsageSlider({ 
  ...
  if (!tokenLimit || currentTokens === undefined) {
    ...
    return (
      <div
        className="flex items-center gap-2 px-3 py-1.5 bg-white/50 dark:bg-[#2a2a3c]/50 backdrop-blur rounded-lg border border-gray-200/60 dark:border-gray-700 w-56"
